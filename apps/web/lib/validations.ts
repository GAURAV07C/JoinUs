...
export const signupSchema = z
  ...
  .refine(
    ...
    {
      message: "College and department are required for students and organizers",
      path: ["college"],
    },
  )
  .refine(
...
export const eventSchema = z.object({
  ...
  maxCapacity: z.number().min(1, "Capacity must be at least 1").max(10000, "Capacity is too large"),
  price: z.number().min(0, "Price cannot be negative").max(100000, "Price is too high"),
