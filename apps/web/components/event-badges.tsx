...
export function EventBadges({ event, attendancePercentage }: EventBadgesProps): React.ReactNode {
  if (!event) {
    return null
  }
  ...
  return (
    <>
      ...
      <div className="absolute bottom-4 right-4">
        <Badge variant="outline" className="bg-white/90 text-slate-800 border-0 backdrop-blur-sm">
